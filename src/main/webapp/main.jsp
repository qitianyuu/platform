        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar" >
            ...
            <li style="padding-left:20px;">
			 <ul class="nav nav-sidebar">
				<li>
				   <a href="javascript:void(0)" onclick="toggleNav(this)">会员中心</a>
				   <ul class="nav nav-sidebar nav_hidden" >
					   <li><a href="javascript:void(0)" onclick="setURL(this)" url="<%=basePath%>emp/selectEmpList" >DEMO_查询员工信息</a></li>
				...
				<li>
				 <a href="javascript:void(0)" onclick="toggleNav(this)">采购申请管理</a>
				  <ul class="nav nav-sidebar nav_hidden">
				    <li><a href="javascript:void(0)">采购需求创建</a></li>
				    <li><a href="javascript:void(0)">采购需求查询</a></li>
					<li><a href="javascript:void(0)">采购需求申请查询</a></li>
				  </ul>
				</li>
				 <li>
					 <a href="javascript:void(0)" onclick="toggleNav(this)">保证金管理</a>
					 <ul class="nav nav-sidebar nav_hidden">
						 <li><a href="javascript:void(0)">保证金明细</a></li>
